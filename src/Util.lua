...
function GenerateQuadsBlocks(atlas)
    return GenerateQuads(atlas, 36, 36)
end

function GenerateQuadsGrounds(atlas)
    return GenerateQuads(atlas, 1100, 16)
end

function GenerateQuadsPlayer(atlas)
    return table.slice(GenerateQuads(atlas, 32, 48), 1, 25)
end